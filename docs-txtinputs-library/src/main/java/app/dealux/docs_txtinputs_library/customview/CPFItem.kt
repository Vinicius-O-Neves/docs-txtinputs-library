...
open class CPFItem @JvmOverloads constructor(
  context: Context,
  attrs: AttributeSet?,
  defStyleAttr: Int = 0,
  ...
  var defaultMinLength = 10
  var defaultMaxLength = 15
  ...
  var docCounterMaxLength: Int by Delegates.observable(
    defaultMaxLength) { _, _, new ->
    binding.docInputLayout.counterMaxLength = new
  }

  var docHintText: String by Delegates.observable(initialValue = context.getString(
    R.string.default_hint)) { _, old, new ->
  ...
  private fun setLayout(attrs: AttributeSet?) {
    attrs?.let { attributeSet ->
      ...
      docCounterMaxLength = attributes.getInt(R.styleable.CPFItem_docCounterMaxLength, defaultMaxLength)
      docCounterMinLength = attributes.getInt(R.styleable.CPFItem_docCounterMinLength, defaultMinLength)
      docHintText = attributes.getString(R.styleable.CPFItem_docHintText) ?: context.getString(R.string.default_hint)
